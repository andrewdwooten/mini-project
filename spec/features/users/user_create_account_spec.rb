...
feature 'user can create an account' do
  ...
  scenario 'user submits incomplete information and is redirected to the new user page' do
  ...
  scenario 'user already exists and current user is redirected to the new user page' do
